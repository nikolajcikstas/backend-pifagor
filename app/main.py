        ...
        async with asyncio.timeout(30):
            async with engine.begin() as conn:
                ...
                for sql in (
                    ...
                    "DELETE FROM invite_codes WHERE description IS NOT NULL AND (length(description) > 120 OR lower(description) LIKE '%admin%' OR lower(description) LIKE '%админ%' OR description !~ '^[A-Za-zА-Яа-яЁёЎўІіЇїЄє0-9 .''-]{0,120}$')",
